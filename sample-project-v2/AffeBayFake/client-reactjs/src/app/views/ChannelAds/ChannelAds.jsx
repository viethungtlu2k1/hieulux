...
import {
    ...
    deleteItem,
    getItemById,
} from "./ChannelAdsService";


import AgencyDialog from "./ChannelAdsDialog";
...
class ChannelAds extends React.Component {
    state = {
        rowsPerPage: 10,
        page: 0,
        data: [],
    ...
    render() {
        ...
        let TitlePage = t("Kênh quảng cáo");
        ...
        let columns = [
            ...
            { title: t("general.name"), field: "name" },
            { title: t("general.code"), field: "code", align: "left" }
        ];
