...
import AgencyDialog from "./CampaignDialog";
...
class Campaign extends React.Component {
    ...
    render() {
        ...
        let columns = [
            ...
            {
                title: t("Campaign.campaignType"), field: "campaignType.name", align: "left", width: "150",
            },
            { 
                title: t("general.startdate"), field: "startDate", align: "left", width: "150", 
                render: rowdata =>
                    (rowdata.startDate) ? <span>{moment(rowdata.startDate).format("DD-MM-YYYY")}</span> : '' 
            },
            { 
                title: t("general.enddate"), field: "endDate", align: "left", width: "150",
                render: rowdata =>
                    (rowdata.startDate) ? <span>{moment(rowdata.endDate).format("DD-MM-YYYY")}</span> : ''  
            },
            { title: t("Campaign.epc"), field: "epc", align: "left", width: "150" },
            { title: t("Campaign.cvr"), field: "cvr", align: "left", width: "150" },
            { title: t("Campaign.commission"), field: "commission", align: "left", width: "150" },
            { title: t("Campaign.approvedRate30Days"), field: "approved_rate_30days", align: "left", width: "150" },
            {
                title: t("Product.product"), field: "product.name", align: "left", width: "150",
            },
        ];
