import {
  ...
  import AgencyDialog from "./HolidayDialog";
    ...
    render() {
      ...
      let columns = [
        ...
        { title: t("general.startdate"), field: "startdate", align: "left", width: "150" ,
          render:rowDate =>(rowDate.startdate)?<span>{moment(rowDate.startdate).format("YYYY-MM-DD")}</span>:'' } , 
        { title: t("general.enddate"), field: "enddate", align: "left", width: "150" ,
          render:rowDate =>(rowDate.enddate)?<span>{moment(rowDate.enddate).format("YYYY-MM-DD")}</span>:'' } ,  
        { title: t("general.descriptions"), field: "descriptions", align: "left", width: "150" },    
      ];
      ...
      return (
        <div className="m-sm-30">
          ...
          <div className="mb-sm-30">
            ...
            <Breadcrumb
              routeSegments={[
                { name: t("Dashboard.holiday"), path: "/directory/building" },
                { name: TitlePage },
              ]}
            />
          </div>
