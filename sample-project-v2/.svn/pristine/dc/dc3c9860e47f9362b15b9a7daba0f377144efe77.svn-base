...
import {
  ...
  getAllItem,
  deleteCheckItem,
} from "./CampaignTypeService";


import AgencyDialog from "./CampaignTypeDialog";
...
class CampaignType extends React.Component {
  state = {
    rowsPerPage: 10,
    page: 0,
    data: [],
  ...
  render() {
    ...
    let TitlePage = t("Loại Chiến Dịch");
    ...
    let columns = [
      ...
      { title: t("general.descriptions"), field: "description", align: "left", width: "150" },   
    ];
