...
import AgencyDialog from "./CurrencyDialog";
...
class Currency extends React.Component {
  ...
  render() {
    ...
    let columns = [
      ...
      { title: t("general.currencySymbols"), field: "currencySymbols", align: "left", width: "150" },     
    ];
    ...
    return (
      <div className="m-sm-30">
        ...
        <div className="mb-sm-30">
          ...
          <Breadcrumb
            routeSegments={[
              { name: t("Dashboard.Currency"), path: "/directory/building" },
              { name: TitlePage },
            ]}
          />
        </div>
