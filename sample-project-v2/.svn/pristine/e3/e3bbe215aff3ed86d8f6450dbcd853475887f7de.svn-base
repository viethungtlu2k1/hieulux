...
import AgencyDialog from "./SpaceDialog";
...
class AdSpace extends React.Component {
    ...
    updatePageData = () => {
        var searchObject = {};
        searchObject.keyword = this.state.keyword !== "" ? this.state.keyword : "";
        searchObject.pageIndex = this.state.page + 1;
        searchObject.pageSize = this.state.rowsPerPage;
    ...
    render() {
        ...
        let columns = [
            ...
            { title: t("general.channel"), field: "channelName", align: "left", width: "200" },
            { title: t("general.nameYoutube"), field: "nameYoutube", align: "left", width: "200" },
            { title: t("general.urlWebsite"), field: "urlWebsite", align: "left", width: "200" },
            { title: t("general.url_page"), field: "url_page", align: "left", width: "200" },
            { title: t("general.network"), field: "network", align: "left", width: "150" },
            { title: t("general.contextualAdvertisingSystem"), field: "contextualAdvertisingSystemName", align: "left", width: "150" },
            { title: t("general.experience"), field: "experience", align: "left", width: "150" },
            { title: t("general.description"), field: "description", align: "left", width: "150" },
        ];
        ...
        return (
            <div className="m-sm-30">
                ...
                <div className="mb-sm-30">
                    ...
                    <Breadcrumb
                        routeSegments={[
                            { name: t("Dashboard.Space"), path: "/directory/building" },
                            { name: TitlePage },
                        ]}
                    />
                </div>
