import {
  ...
  import {
    ...
    getAllItem,
    deleteCheckItem,
  } from "./ProjectManagermentService";
  
  
  import AgencyDialog from "./ProjectManagermentDialog";
  ...
  function MaterialButton(props) {
    ...
    return (
      <div className="none_wrap">
        ...
        <LightTooltip
          title={t("general.listIcon")}
          placement="right-end"
          enterDelay={300}
          leaveDelay={200}
        >
          <IconButton size="small" onClick={() => props.onSelect(item, "openInfoEmployees")}>
      ...
      return (
        <div className="m-sm-30">
          ...
          <div className="mb-sm-30">
            ...
            <Breadcrumb
              routeSegments={[
                { name: t("Dashboard.Project"), path: "/directory/building" },
                { name: TitlePage },
              ]}
            />
          </div>
